...
Revision ID: d27e0a5b9893
Revises: 
Create Date: 2023-10-08 03:08:19.702403
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('lesson_date', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
